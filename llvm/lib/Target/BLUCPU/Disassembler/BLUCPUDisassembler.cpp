//===- BLUCPUDisassembler.cpp - Disassembler for BLUCPU ---------------*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file is part of the BLUCPU Disassembler.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "blucpu-disassembler"

typedef MCDisassembler::DecodeStatus DecodeStatus;

namespace {

/// A disassembler class for BLUCPU.
class BLUCPUDisassembler : public MCDisassembler {
public:
  BLUCPUDisassembler(const MCSubtargetInfo &STI, MCContext &Ctx)
      : MCDisassembler(STI, Ctx) {}
  virtual ~BLUCPUDisassembler() = default;
...
static MCDisassembler *createBLUCPUDisassembler(const Target &T,
                                             const MCSubtargetInfo &STI,
                                             MCContext &Ctx) {
  return new BLUCPUDisassembler(STI, Ctx);
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeBLUCPUDisassembler() {
  // Register the disassembler.
  TargetRegistry::RegisterMCDisassembler(getTheBLUCPUTarget(),
                                         createBLUCPUDisassembler);
}

static const uint16_t GPRDecoderTable[] = {
    BLUCPU::R0,  BLUCPU::R1,  BLUCPU::R2,  BLUCPU::R3,  BLUCPU::R4,  BLUCPU::R5,  BLUCPU::R6,
    BLUCPU::R7,  BLUCPU::R8,  BLUCPU::R9,  BLUCPU::R10, BLUCPU::R11, BLUCPU::R12, BLUCPU::R13,
    BLUCPU::R14, BLUCPU::R15, BLUCPU::R16, BLUCPU::R17, BLUCPU::R18, BLUCPU::R19, BLUCPU::R20,
    BLUCPU::R21, BLUCPU::R22, BLUCPU::R23, BLUCPU::R24, BLUCPU::R25, BLUCPU::R26, BLUCPU::R27,
    BLUCPU::R28, BLUCPU::R29, BLUCPU::R30, BLUCPU::R31,
};
...
#include "BLUCPUGenDisassemblerTables.inc"
...
static DecodeStatus decodeFLPMX(MCInst &Inst, unsigned Insn, uint64_t Address,
  ...
  if (decodeFRd(Inst, Insn, Address, Decoder) == MCDisassembler::Fail)
    return MCDisassembler::Fail;
  Inst.addOperand(MCOperand::createReg(BLUCPU::R31R30));
  return MCDisassembler::Success;
}
...
static DecodeStatus decodeMemri(MCInst &Inst, unsigned Insn, uint64_t Address,
                                const MCDisassembler *Decoder) {
  // As in the EncoderMethod `BLUCPUMCCodeEmitter::encodeMemri`, the memory
  ...
  Inst.addOperand(
      MCOperand::createReg((Insn & 0x40) ? BLUCPU::R29R28 : BLUCPU::R31R30));
...
static DecodeStatus decodeFBRk(MCInst &Inst, unsigned Insn, uint64_t Address,
  ...
  switch (Insn & 0xf000) {
  case 0xc000:
    Inst.setOpcode(BLUCPU::RJMPk);
    break;
  case 0xd000:
    Inst.setOpcode(BLUCPU::RCALLk);
    break;
...
static DecodeStatus decodeCondBranch(MCInst &Inst, unsigned Insn,
  ...
  DenseMap<unsigned, unsigned> brInsts = {
      {0x000, BLUCPU::BRLOk}, {0x400, BLUCPU::BRSHk}, {0x001, BLUCPU::BREQk},
      {0x401, BLUCPU::BRNEk}, {0x002, BLUCPU::BRMIk}, {0x402, BLUCPU::BRPLk},
      {0x004, BLUCPU::BRLTk}, {0x404, BLUCPU::BRGEk}};
  ...
  if (It != brInsts.end()) {
    ...
    Inst.setOpcode(Insn & 0x400 ? BLUCPU::BRBCsk : BLUCPU::BRBSsk);
...
static DecodeStatus decodeLoadStore(MCInst &Inst, unsigned Insn,
  ...
  switch (Insn & 0xc) {
  case 0xc:
    RegBase = BLUCPU::R27R26;
    break;
  case 0x8:
    RegBase = BLUCPU::R29R28;
    break;
  case 0x0:
    RegBase = BLUCPU::R31R30;
    break;
  default:
    return MCDisassembler::Fail;
  }
  ...
  switch (Insn & 0x203) {
  case 0x200:
    Inst.setOpcode(BLUCPU::STPtrRr);
    Inst.addOperand(MCOperand::createReg(RegBase));
    Inst.addOperand(MCOperand::createReg(RegVal));
    return MCDisassembler::Success;
  case 0x201:
    Inst.setOpcode(BLUCPU::STPtrPiRr);
    break;
  case 0x202:
    Inst.setOpcode(BLUCPU::STPtrPdRr);
    break;
  case 0:
    Inst.setOpcode(BLUCPU::LDRdPtr);
    Inst.addOperand(MCOperand::createReg(RegVal));
    Inst.addOperand(MCOperand::createReg(RegBase));
    return MCDisassembler::Success;
  case 1:
    Inst.setOpcode(BLUCPU::LDRdPtrPi);
    break;
  case 2:
    Inst.setOpcode(BLUCPU::LDRdPtrPd);
    break;
  default:
    return MCDisassembler::Fail;
  }
...
DecodeStatus BLUCPUDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
