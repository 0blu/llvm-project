//===- BLUCPUShift.cpp - Shift Expansion Pass --------------------------------===//
//
...
/// inline loops, just like blucpu-gcc. This must be done in IR because otherwise
...
class BLUCPUShiftExpand : public FunctionPass {
public:
  static char ID;

  BLUCPUShiftExpand() : FunctionPass(ID) {}

  bool runOnFunction(Function &F) override;

  StringRef getPassName() const override { return "BLUCPU Shift Expansion"; }
...
char BLUCPUShiftExpand::ID = 0;

INITIALIZE_PASS(BLUCPUShiftExpand, "blucpu-shift-expand", "BLUCPU Shift Expansion",
                false, false)

Pass *llvm::createBLUCPUShiftExpandPass() { return new BLUCPUShiftExpand(); }

bool BLUCPUShiftExpand::runOnFunction(Function &F) {
...
void BLUCPUShiftExpand::expand(BinaryOperator *BI) {
