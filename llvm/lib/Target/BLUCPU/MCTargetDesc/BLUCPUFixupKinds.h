//===-- BLUCPUFixupKinds.h - BLUCPU Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_BLUCPU_FIXUP_KINDS_H
#define LLVM_BLUCPU_FIXUP_KINDS_H
...
///       MCFixupKindInfo Infos[BLUCPU::NumTargetFixupKinds]
///       in `BLUCPUAsmBackend.cpp`.
enum Fixups {
  /// A 32-bit BLUCPU fixup.
  ...
  ///       The nonmenclature is that BLUCPU branch targets are
...
/// All branch targets in BLUCPU are rightshifted by 1 to take advantage
...
#endif // LLVM_BLUCPU_FIXUP_KINDS_H
